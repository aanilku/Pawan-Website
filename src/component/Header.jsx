          ...
          <div className="search-header-inner">
            ...
            <div className="product-search-category">
              <form action="#">
                ...
                <div className="nice-select wide" tabIndex="0">
                  ...
                  <ul className="list">
                    <li data-value="All Categories" className="option selected">
                      All Categories
                    </li>
                    <li data-value="Man Shirts" className="option">
                      Man Shirts
                    </li>
                    <li data-value="Denim Jeans" className="option">
                      Denim Jeans
                    </li>
                    <li data-value="Casual Suit" className="option">
                      Casual Suit
                    </li>
                    <li data-value="Summer Dress" className="option">
                      Summer Dress
                    </li>
                    <li data-value="Sweaters" className="option">
                      Sweaters
                    </li>
                    <li data-value="Jackets" className="option">
                      Jackets
                    </li>
                  </ul>
                </div>
            ...
            <div className="hotline-support item-rtl">
              ...
              <div className="info">
                ...
                <h5>
                  <Link to="tel:+941234567894">+94 123 4567 894</Link>
                </h5>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="primary-menu">
            ...
            <div className="nav-inner-menu">
              ...
              <div className="main-categories-wrap d-none d-lg-block">
                <Link className="categories-btn-active" to="/">
                  ...
                  <span className="text">
                    Products Category<i className="fas fa-angle-down"></i>
                  </span>
                </Link>
                <div className="categories-dropdown-wrap categories-dropdown-active">
                    ...
                    <ul>
                      <li>
                        <Link to="/shop">
                          {" "}
                          <img
                            src="/src/assets/images/icon/shirt.png"
                            alt="Shirts"
                          />
                          Man Shirts
                        </Link>
                      ...
                      <li>
                        <Link to="/shop">
                          {" "}
                          <img
                            src="/src/assets/images/icon/denim.png"
                            alt="Jeans"
                          />
                          Denim Jeans
                        </Link>
                      ...
                      <li>
                        <Link to="/shop">
                          {" "}
                          <img
                            src="/src/assets/images/icon/suit.png"
                            alt="Suit"
                          />
                          Casual Suit
                        </Link>
                      ...
                      <li>
                        <Link to="/shop">
                          {" "}
                          <img
                            src="/src/assets/images/icon/dress.png"
                            alt="Dress"
                          />
                          Summer Dress
                        </Link>
                      ...
                      <li>
                        <Link to="/shop">
                          {" "}
                          <img
                            src="/src/assets/images/icon/sweaters.png"
                            alt="Sweaters"
                          />
                          Sweaters
                        </Link>
                    ...
                    <div className="categori-dropdown-item">
                      <ul>
                        <li>
                          <Link to="#">
                            <img
                              src="/src/assets/images/icon/jacket.png"
                              alt="Jackets"
                            />
                            Jackets
                          </Link>
                  ...
                  <div className="more_categories">
                    <span className="icon"></span> <span>Show more...</span>
                  </div>
                </div>
              </div>
              {/* <!--=== Pesco Nav Main ===--> */}
                          ...
                          <ul>
                            <li className="menu-item has-children">
                              ...
                              <ul className="sub-menu">
                                ...
                                <li>
                                  <Link to="/indexPage">Home 02</Link>
                                </li>
                              </ul>
                            </li>
                            <li className="menu-item has-children">
                              ...
                              <ul className="sub-menu">
                                ...
                                <li>
                                  <Link to="/shopDetails">Product Details</Link>
                                </li>
                                <li>
            ...
            <div className="nav-right-item style-one">
              <ul>
                <li>
                  <div className="deals d-lg-block d-none">
                    <i className="far fa-fire-alt"></i>Deal
                  </div>
                </li>
                <li>
                  <div className="wishlist-btn d-lg-block d-none">
                    <i className="far fa-heart"></i>
                    <span className="pro-count">12</span>
                  </div>
                </li>
                <li>
                  <div className="cart-button d-flex align-items-center">
                    <div className="icon">
                      ...
                      <span className="pro-count">01</span>
                    </div>
                  </div>
                </li>
              </ul>
