  ...
  return (
    <div>
        ...
        <main className="main-bg">
            ...
            {/*<!--====== End Page Banner  ======-->*/}
            {/*<!--====== Start Faqs Section  ======-->*/}
            <section className="faqs-section pt-120 pb-115">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-4">
                            <div className="faqs-search float-md-end mb-90">
                                <form>
            ...
            <section className="faq-contact-section pb-90">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7">
                            <div className="contact-form-wrapper mb-40">
                                <form className="pesco-contact-form">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <textarea className="form_control" placeholder="Write Reviews" name="message" cols="10" rows="9" required></textarea>
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                                            <div className="form-group">
