            ...
            <section className="page-banner">
                ...
                <div className="page-banner-wrapper p-r z-1">
                    ...
                    <div className="page-image">
                        <img src="/src/assets/images/bg/page-img-1.png" alt="image" />
                        </div>
                    ...
                    <div className="shape shape-four"><span>
                        <img src="/src/assets/images/shape/stars.png" alt="" />
                        </span></div>                
                ...
                <div className="headline-wrap style-two pt-25 pb-25 white-bg">
                    <span className="marquee-wrap">
                        <span className="marquee-inner left">
                            <span className="marquee-item"><b>OUR GLOBAL OFFICE ADDRESS</b><i className="flaticon-star-2"></i></span>
                            <span className="marquee-item"><b>OUR GLOBAL OFFICE ADDRESS</b><i className="flaticon-star-2"></i></span>
                        </span>
                        <span className="marquee-inner left">
                            <span className="marquee-item"><b>OUR GLOBAL OFFICE ADDRESS</b><i className="flaticon-star-2"></i></span>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="single-information-wrapper">
                                <div className="single-information-item d-flex justify-content-between mb-15">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="contact-wrapper p-r z-1 mb-50">
                                <div className="shape shape-one"><span><img src="/src/assets/images/shape/cl-line.png" alt="Line Shape" /></span></div>
                                <h3>Get in touch</h3>
                                <form className="pesco-contact-form">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="form-group">
                                                <textarea className="form_control" placeholder="Write Reviews" name="message" cols="5" rows="9"></textarea>
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                        ...
                        <div className="col-lg-4">
                            <div className="contact-img-text text-center mb-50 d-none d-lg-block">
                                <img src="/src/assets/images/contact/text-img.png" alt="Text" />
                            </div>
                        </div>
                    </div>
                </div>
