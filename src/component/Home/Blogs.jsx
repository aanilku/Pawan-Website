            ...
            <section className="page-banner">
                ...
                <div className="page-banner-wrapper p-r z-1">
                    ...
                    <div className="page-image">
                        <img src="/src/assets/images/bg/page-img-1.png" alt="image" /></div>
                      / 
                    ...
                    <div className="shape shape-three"><span>
                        <img src="/src/assets/images/shape/curved-arrow.png" alt="" /></span></div>
            ...
            <section className="blog-page-section pt-120 pb-95">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            {/*<!--=== Blog Post Item  ===-->*/}
                            <div className="blog-post-item style-one mb-25">
                                <div className="post-thumbnail">
                                    
                                    <img src="/src/assets/images/blog/blog-big-1.png" alt="Post Thumbnail" />

                                </div>
                                <div className="post-content">
                                    <h3 className="title"><a href="blog-details.html">From Clicks to Closets: Mastering the Art of Fashion E-commerce Marketing</a></h3>
                        ...
                        <div className="col-lg-6">
                            <div className="row">
                                <div className="col-sm-6">
                                    {/*<!--=== Blog Post Item  ===-->*/}
                                    <div className="blog-post-item style-two mb-25">
                                        <div className="post-thumbnail">
                                            
                                            <img src="/src/assets/images/blog/blog-sm-1.png" alt="Post Thumbnail" />

                                        </div>
                                        <div className="post-content">
                                            <h3 className="title"><a href="blog-details.html">Slay the Summer Style Game Must-Have Trends You Can Shop Online</a></h3>
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <div className="blog-post-item style-two mb-25">
                                        <div className="post-thumbnail">
                                            ...
                                            <img src="/src/assets/images/blog/blog-sm-2.png" alt="Post Thumbnail" />

                                        </div>
                                        <div className="post-content">
                                            <h3 className="title"><a href="blog-details.html">Insider Tips on Finding Affordable Fashion Gems Online</a></h3>
                                            <div className="post-meta">
                                                <span><a href="#">WordPress</a></span>
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <div className="blog-post-item style-two mb-25">
                                        <div className="post-thumbnail">
                                            ...
                                            <img src="/src/assets/images/blog/blog-sm-3.png" alt="Post Thumbnail" />

                                        </div>
                                        <div className="post-content">
                                            <h3 className="title"><a href="blog-details.html">Eco-Friendly Fashion E-commerce You Can Feel Good About</a></h3>
                                            <div className="post-meta">
                                                <span><a href="#">WordPress</a></span>
                                ...
                                <div className="col-sm-6">
                                    <div className="blog-post-item style-two mb-25">
                                        <div className="post-thumbnail">
                                            ...
                                            <img src="/src/assets/images/blog/blog-sm-4.png" alt="Post Thumbnail" />

                                        </div>
                                        <div className="post-content">
                                            <h3 className="title"><a href="blog-details.html">A Guide to Streamlining the Online Fashion Shopping Experience</a></h3>
                                            <div className="post-meta">
                                                <span><a href="#">WordPress</a></span>
                    ...
                    <div className="blogs-wrapper">
                        <div className="row">
                            <div className="col-xl-8">
                                {/*<!--=== Blog Post Item ===-->*/}
                                <div className="blog-post-item style-four">
                                    <div className="post-thumbnail">
                                        
                                        <img src="/src/assets/images/blog/blog-sm-5.png" alt="Post Thumbnail" />

                                    </div>
                                    <div className="post-content">
                                        <h3 className="title"><a href="blog-details.html">3 unexpected hacks to unleash your hidden creativity.</a></h3>
                                ...
                                <div className="blog-post-item style-four">
                                    <div className="post-thumbnail">
                                        ...
                                        <img src="/src/assets/images/blog/blog-sm-6.png" alt="Post Thumbnail" />

                                    </div>
                                    <div className="post-content">
                                        <h3 className="title"><a href="blog-details.html">The ultimate guide to ecommerce in 2024: everything you need to know</a></h3>
                                ...
                                <div className="blog-post-item style-four">
                                    <div className="post-thumbnail">
                                        ...
                                        <img src="/src/assets/images/blog/blog-sm-7.png" alt="Post Thumbnail" />

                                    </div>
                                    <div className="post-content">
                                        <h3 className="title"><a href="blog-details.html">Do delivery? youre not alone! heres how to fix it fast</a></h3>
                                        <p>Youre definitely not the only one! This post acknowledges a widespread issue and offers quick and effective solutions to get you back on track. Stop feeling overwhelmed and learn how to tackle this common problem</p>
                                        <div className="post-meta">
                                            <span><a href="#">Shopify</a></span>
                            ...
                            <div className="col-xl-4">
                                <div className="sidebar-widget-area">
                                    ...
                                    <div className="sidebar-banner-widget mb-40">
                                        <div className="banner-widget-content">
                                            <div className="banner-shape">
                                                <img src="/src/assets/images/widget/banner-shape-1.png" alt="shape" /></div>

                                            <div className="banner-img">
                                                <img src="/src/assets/images/widget/banner-1.png" alt="image" /></div>
                                    ...
                                    {/*<!--=== Sidebar Widget ===-->*/}
                                    <div className="sidebar-newsletter-widget">
